...
void VulkanContext::Initialize(GLFWwindow* window, bool enableValidation) {
    m_Window = window;
...
void VulkanContext::CreateInstance(bool enableValidation) {
    ...
    appInfo.pApplicationName = "Vulkan2D Application";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "Vulkan2D";
...
VkExtent2D VulkanContext::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, int width, int height) const {
